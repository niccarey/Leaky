...
def main():
    ...
    l_green, u_green = boundary_estimate(init_crop.copy(), lg_bound, ug_bound, 30, 255, 0, 255, 15)
    ...
    while running:
        ...
        if (leaky1.is_turning()) or (leaky1.is_deposit()) or (leaky1.is_backup()):
            ...
            if (leaky1.is_turning()):
                ...
                if leaky1.high_humidity:
                    ...
                    rednum, red_frame = leaving_home(cp, omni_frame, wide_mask, l_red, u_red)
        ...
        if leaky1.is_sensing():
            ...
            if (time.time() - leaky1.sensing_clock < 45):
                time.sleep(0.1)
